...
class CatScratchEditorProvider {
    ...
    getHtmlForWebview(webview) {
        ...
        console.log({ level: "dev", msg: "getting HTMl", scriptUri, styleResetUri, styleVSCodeUri, styleMainUri });
...
CatScratchEditorProvider.viewType = 'kanbanDown.editor';
CatScratchEditorProvider.scratchCharacters = ['😸', '😹', '😺', '😻', '😼', '😽', '😾', '🙀', '😿', '🐱'];
//# sourceMappingURL=cat-editor%20copy.js.map